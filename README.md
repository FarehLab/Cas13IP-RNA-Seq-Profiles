...
> **CRISPR-Cas13 Localises Within RNA-Rich Condensates To Drive RNA Recognition and Cleavage**
...
This repository contains differential expression data from RNA immunoprecipitation sequencing (RIP-Seq) experiments characterising the RNA binding profile of PspCas13b across subcellular fractions in HEK293T cells. Data are provided as processed differential expression tables and can be explored interactively via the link above.
